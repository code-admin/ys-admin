<template>
  <div class="app-container">
    ...
    <el-table :key="tableKey" v-loading="listLoading" :data="feedbackList" border fit highlight-current-row style="width: 100%;">
      ...
      <el-table-column label="具体说明" prop="description" align="left" width="200" show-overflow-tooltip />
      ...
      <el-table-column label="订单时间" prop="orderTime" align="center" width="160" />
      <el-table-column label="生产时间" prop="productDate" align="center" width="100" />
      <el-table-column label="机台号" prop="deviceNo" align="center" />
      <el-table-column label="产品名称" prop="productTypeName" align="center" />
      ...
      <el-table-column label="操作" fixed="right" prop="id" align="center" width="90">
        <template slot-scope="scope">
