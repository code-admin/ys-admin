      ...
      <div class="content mt20">
        <el-form label-position="right" label-width="80px" :model="orderInfo">
          ...
          <el-form-item label="收货地址">
            <el-cascader v-model="orderInfo.pcct" :props="props" clearable placeholder="省/市/区" style="width:100%;" />
...
export default {
  ...
  methods: {
    ...
    saveOrderInfo() {
      const params = {
        ...this.orderInfo,
        province: this.orderInfo.pcct[0],
        city: this.orderInfo.pcct[1],
        district: this.orderInfo.pcct[2]
      }
