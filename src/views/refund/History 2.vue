...
<div class="app-container">
    ...
    <el-table v-loading="listLoading" :data="dataList" border style="width: 100%;" size="mini">
        ...
        <el-table-column label="操作" align="center" width="80">
            <template slot-scope="{row}">
                <el-popconfirm confirm-button-text="确定" confirm-button-type="danger" cancel-button-text="取消" icon="el-icon-info" icon-color="red" title="您确定要删除该记录吗?" @onConfirm="handleDelete(row)">
