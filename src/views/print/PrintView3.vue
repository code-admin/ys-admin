      ...
      <div style="width:100%;height:100%;">
        ...
        <table style="border-collapse:collapse;border:none;" width="100%">
          ...
          <tr v-for="(order,index) in print.details" :key="index" class="tr">
            ...
            <td class="lab">{{ order.length ? order.length : '' }}</td>
            <td class="lab">{{ order.goodsNumber }}</td>
            <td class="lab">{{ order.productNumber }}</td>
            <td class="lab">{{ order.totalWeight }}</td>
            <td class="lab">{{ order.tareWeight ? order.tareWeight : '' }}</td>
            <td class="lab">{{ order.price }}</td>
            <td class="lab">{{ order.netWeight }}</td>
            <td class="lab">{{ order.amount }}</td>
            <td class="lab">{{ order.remark }}</td>
          </tr>
          <tr class="tr">
            <td class="lab">地址:</td>
            <td class="text" style="text-align:left;padding-left: 15px;" colspan="12">{{ print.delivery }}</td>
          </tr>
          <tr class="tr">
            <td class="lab">欠款:</td>
            ...
            <td class="lab">金额</td>
            <td class="text" colspan="2">{{ print.totalAmount }}</td>
          </tr>
          <tr class="tr">
            <td class="lab">制单:</td>
