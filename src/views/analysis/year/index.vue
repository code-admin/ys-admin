  ...
  <div class="app-container">
    ...
    <div v-loading="listLoading" style="margin-top:20px;">
      <el-table v-if="!!produceList" :data="produceList" border>
        ...
        <el-table-column prop="year" label="年度" align="center" width="80" />
        <el-table-column prop="produceWeight" label="生产重量（kg）" align="center" width="80" />
        <el-table-column prop="produceLength" label="生产米数（cm）" align="center" width="130" />
        <el-table-column prop="totalWidth" label="总宽度（cm）" align="center" width="80" />
        <el-table-column prop="bonus" label="奖励" align="center" width="70" />
        ...
        <el-table-column prop="capacityAvgDay" label="日均产能" align="center" width="120" />
        <el-table-column prop="totalDevice" label="总机台数" align="center" width="70" />
        <el-table-column prop="dayDevice" label="每天机台数" align="center" width="100" />
        <el-table-column prop="produceDevice" label="生产机台数（台）" align="center" width="80" />
        <el-table-column prop="unproduceDevice" label="未生产机台数（台）" align="center" width="100" />
        <el-table-column prop="produceNumber" label="生产筒布（个）" align="center" width="90" />
        <el-table-column prop="noWeighingDevice" label="不称重（台）" align="center" width="80" />
        <el-table-column prop="noWeightDevice" label="不算克重（个）" align="center" width="80" />
        ...
        <el-table-column prop="staffNumber" label="员工人数" align="center" width="80" />
        <el-table-column prop="staffTotalClasses" label="员工总班次" align="center" width="80" />
        <el-table-column prop="totalSalary" label="总工资" align="center" width="80" />
        <el-table-column prop="staffClassSalary" label="员工班次工资" align="center" width="80" />
      </el-table>
    </div>
    <div class="block">
