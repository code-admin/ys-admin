      ...
      <el-table-column label="操作" align="center" show-overflow-tooltip>
        <template slot-scope="{ row }">
          <div>
            ...
            <el-button type="text" size="mini" @click="editInit(row)"
              >修改</el-button
            >
            <el-divider direction="vertical"></el-divider>
    ...
    <el-dialog :title="title" :visible.sync="dialogFormVisible">
      <el-form :model="rule" size="mini" label-width="80px">
        ...
        <el-form-item label="基础单价">
          <el-input
            v-model="rule.basicPrice"
            autocomplete="off"
            placeholder="请输入基础单价"
            ><template slot="append">元/吨</template></el-input
          >
        </el-form-item>
        <el-form-item label="其他">
          <el-input
            v-model="rule.otherPrice"
            autocomplete="off"
            placeholder="请输入其他"
...
<script>
import { queryList, saveRule, deleteRuleById } from "@/api/adjusted.js";
export default {
  name: "Adjusted",
  data() {
    return {
