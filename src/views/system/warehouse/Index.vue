    ...
    <el-row :gutter="20">
      <el-col :span="12">
        ...
        <el-table :data="dataList" style="width: 100%" size="mini">
          ...
          <el-table-column prop="action" label="禁用/启用" width="80">
            <template slot-scope="{ row }">
              <div>
      ...
      <el-col :span="12">
        <el-form ref="warehouse" :model="warehouse" :rules="warehouseRules" label-width="80px" size="mini">
          ...
          <div class="map-box">
            <el-amap v-if="showMap" vid="edit_warehouse" :amap-manager="amapManager" :center="mapCenter" :zoom="mapZoom" />
          </div>
          <el-form-item>
            <div class="form-button">
              <el-button type="primary" @click="saveData('warehouse')">保存仓库</el-button>
            </div>
          </el-form-item>
        </el-form>
      </el-col>
...
import { getShippingAddressList, enable, saveShippingAddress } from '@/api/org'
